...
class AStarPathfinder:
    ...
    def move_robot_along_path(self, motor_controller, path, gyro, resolution=1.0, segment_length_cm=10):
        """
        ...
        for target_position in path:  # Move towards each point in the path
            ...
            print(
                f"Next target grid position: {target_position}, Angle: {target_angle:.2f}°, Distance: {target_distance:.2f} meters")
