...
class AStarPathfinder:
    ...
    def move_robot_along_path(self, stdscr, motor_controller, path, gyro, resolution=1.0, segment_length_cm=100,
        ...
        :param angle_tolerance: Maximum allowed angle difference before correction (in degrees).
        """
        stdscr.clear()
        stdscr.addstr(0, 0, "Pathfinding...")

        current_position = self.mapper.get_robot_grid_position(self.map_grid,
                                                               resolution)  # Get the grid position of the robot
