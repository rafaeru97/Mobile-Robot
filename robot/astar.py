...
class AStarPathfinder:
    ...
    def calculate_angle_and_distance(self, current_position, target_position):
        """
        Calculate the angle and distance from current position to target position.
        ...
        :return: (angle, distance) in degrees and cm.
        """
        delta_x = target_position[0] - current_position[0]
        delta_y = target_position[1] - current_position[1]
        distance = math.sqrt(delta_x ** 2 + delta_y ** 2)  # Calculate distance
        angle = math.degrees(math.atan2(delta_y, delta_x))  # Calculate angle in degrees
    ...
    def move_robot_along_path(self, motor_controller, path, gyro):
        ...
        :param robot: Robot object with control methods.
        ...
        for target_position in path[1:]:  # Move towards each point in the path
            ...
            motor_controller.forward_with_encoders(target_distance)
